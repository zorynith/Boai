<template>
  <footer id="main-footer" class="main-footer">
    <div class="footer-content">
      <div class="copyright">
        <span class="time">@ 1998 - {{ thisYear }} By </span>
        <a :href="theme.siteMeta.author.link" class="author link" target="_blank">
          {{ theme.siteMeta.author.name }}
        </a>
        <a class="icp link" href="http://search.gjsy.gov.cn/wsss/view" target="_blank">
          <i class="iconfont icon-safe" />
          {{ theme.icp }}
        </a>
      </div>
      <div class="meta">
        <a class="power link" href="https://minelibs.eu.org/" target="_blank">
          <span class="by">Powered by</span>
          <span class="name">Minelibs</span>
        </a>
        <a class="theme link" href="https://github.com/qyboaicz/qyboaicz.github.io" target="_blank">
          <span class="name">Github</span>
        </a>
        <a class="rss link" href="https://boai.minelibs.eu.org/rss.xml" target="_blank">
